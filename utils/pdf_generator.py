...
from utils.api_functions import fetch_transfer_data, fetch_client_data



# Registrar tu fuente OTF
pdfmetrics.registerFont(TTFont("Satoshi-Regular", "utils/fonts/Satoshi-Regular.ttf"))
pdfmetrics.registerFont(TTFont("Satoshi-Bold", "utils/fonts/Satoshi-Bold.ttf"))
# =============================================================================
...
def extract_transfer_data(transfer_json: dict) -> dict:
    ...
    """
    amount = format_money(
        transfer_json.get("receipt", {}).get("subtotal_amount", ""), 
    ...
    imad = transfer_json.get("destination", {}).get("imad", "")
...
def create_header_footer_function(logo_path: str = None):
    ...
    def draw_header_footer(canvas, doc_obj):
        ...
        canvas.setFont("Satoshi-Regular", 8)
...
def build_wire_transfer_pdf(transfer_data: dict, client_data: dict, 
    ...
    left_data = [
        ["Transaction ID:", transfer_data["transfer_id"]],
        ["Upload date:", transfer_data["created_at"]],
        #["FED Acceptance Time:", ""],
        #["Effective Date:", transfer_data["created_at"]],
        ["Amount:", transfer_data["amount"]],
        ["Status:", underscore_to_space(transfer_data["status"])]
    ]
    
    right_data = [
        ["IMAD:", transfer_data["imad"]],
        ["Upload Date:", transfer_data["created_at"]],
        ["From account:", client_data["full_name"]],
